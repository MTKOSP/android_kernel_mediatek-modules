...
void wlanDumpHifInfo(P_ADAPTER_T prAdapter)
{
	GL_HIF_INFO_T *HifInfo;
	UINT_32 u4Reg1, u4Reg2, u4Reg3, u4Reg4;

	HifInfo = &prAdapter->prGlueInfo->rHifInfo;
	u4Reg1 = HIF_REG_READL(HifInfo, MCR_WHLPCR);
	u4Reg2 = HIF_REG_READL(HifInfo, MCR_WHISR);
	u4Reg3 = HIF_REG_READL(HifInfo, MCR_WASR);
	u4Reg4 = HIF_REG_READL(HifInfo, MCR_HSTCR);
	DBGLOG(TX, INFO, "WHLPCR: 0x%x, WHISR: 0x%x, WASR: 0x%x, HSTCR: 0x%x\n",
		u4Reg1, u4Reg2, u4Reg3, u4Reg4);
}
